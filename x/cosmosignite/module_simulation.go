package cosmosignite

import (
	"math/rand"

	"cosmos-ignite/testutil/sample"
	cosmosignitesimulation "cosmos-ignite/x/cosmosignite/simulation"
...
var (
	_ = sample.AccAddress
	_ = cosmosignitesimulation.FindAccount
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	cosmosigniteGenesis := types.GenesisState{
	...
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&cosmosigniteGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreatePost,
		cosmosignitesimulation.SimulateMsgCreatePost(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgUpdatePost,
		cosmosignitesimulation.SimulateMsgUpdatePost(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgDeletePost,
		cosmosignitesimulation.SimulateMsgDeletePost(am.accountKeeper, am.bankKeeper, am.keeper),
	))
